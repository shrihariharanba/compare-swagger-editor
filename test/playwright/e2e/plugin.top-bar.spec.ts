...
/**
 * Topbar
 * Tests for top bar menu functionality: File, Edit, Generate, custom workspace menus
 *
...
test.describe('Topbar', () => {
  ...
  test.describe('Custom Top Bar', () => {
    test('should not render the About menu', async ({ page }) => {
